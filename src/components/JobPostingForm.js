...
const Preview = ({ title, description, benefits }) => {
  ...
  const addTableStyles = (html) => {
    ...
    styledHtml = styledHtml
      .replace(
        /<table/g,
        '<table style="border-collapse: collapse !important; border: 1px solid #e5e7eb !important; width: 100% !important; table-layout: fixed !important;"'
      )
      .replace(
        /<td/g,
    ...
    styledHtml = styledHtml.replace(
      /<tbody>\s*<tr>/,
      '<tbody><tr style="background-color: #D7D3BF !important; text-align: center !important; color: black !important;">'
    );
